        ...
        authSection.innerHTML = `
            <div class="relative inline-block text-left" id="user-menu-container">
                <button onclick="toggleUserDropdown(event)" id="user-menu-btn"
                    class="text-xs font-semibold text-gray-700 dark:text-slate-300 bg-gray-100 dark:bg-slate-700 px-3 py-1.5 rounded-xl border border-gray-200 dark:border-slate-600 flex items-center gap-1.5 hover:bg-gray-200 dark:hover:bg-slate-600 transition-all focus:outline-none shadow-sm cursor-pointer">
                ...
                <div id="user-dropdown-menu" class="hidden absolute right-0 mt-2 w-44 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-lg py-1 z-50 transition-all">
                    <button onclick="openEditProfileModal()" class="w-full text-left px-4 py-2 text-xs font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 flex items-center gap-2">
